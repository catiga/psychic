...
func buildSwxy(calId string) (string, error) {
	...
	prompt += "地支的象意参考为:\n"
	prompt += `
	子:	在方位中代表正北，在人物中代表孙子、儿子，在职业中代表小偷、盗贼、黑衣人、斜眼睛的人、秘书、机密人员、保密性工作、流动性质的工作者，在自然环境中代表水、河流、冰，在描述事物中代表流动、转动，在物品中代表车、船，在工作中代表技能，在人物性格中代表圆润、聪明，在人物关系中代表异性缘好，人体中代表肾脏、耳在朵、膀胱、泌尿系统、血液、腰、精子、喉咙，在动物中代表老鼠、蝙蝠、猫头鹰，在场景地点中代表洗手间、下水道、书店、图书馆，水产品市场，在空中代表云气，在地下代表水泽，在描述一个人中代表适应能力强、适合做推广交际，聪明、变化快，头脑清醒精于算计，桃花
	丑:	在方位中代表东北偏北，在人体中代表脾脏、肚腹、嘴唇、皮肤、脚、子宫，在人物中代表老妇、贵人、尊长、神佛、大肚子的人，在动物中代表牛、螃蟹、龟，在环境中代表阴湿的地方、桥梁、银行、土坡，在物品中代表柜子、珠宝、鞋子、首饰、钥匙，在描述一个人中代表忠厚老实、性情倔强，在行业中代表金融行业
	寅:	在方位中代表东北偏东，在物品中代表树木、花草、家居、木制品，在环境场所中代表会所、楼宇、政府机关、文化场所、高雅的场所、山林，在人体中代表受、肢体、胆、毛发、神经、筋脉，在钱财方面代表大的财富、财神
	卯:	在方位中代表东方，物品中代表树木、花草、灌木、纺织物、木材、网络、门窗，卯又被称为门户代表门、窗，在人体中代表肝胆、四肢、毛发、腰，在钱财中代表交易、贸易、合作、结合，在婚姻情感中代表婚姻、约会，在工作事业中代表合作、结合，在描述人的时候，做事情有多手准备，狡兔三窟，桃花
	辰:	在方位中代表东南偏东，在人体中代表膀胱、内分泌、肩、胃、肌肤，在行为中代表争斗、阻止、阻力，征伐、争论，在四位中有两个辰就代表争执、阻力，有五行中土所表示的意思
	巳:	在方位中代表东南偏南，在婚姻情感和工作事业中代表口舌、变化、文章、幻想，在环境中代表闹市、道路，在人体中代表心脏、三焦、咽喉、眼睛、肛门，在动物中代表蛇、蚯蚓，在人物中代表小女孩、年轻女性
	午:	在方位中代表南方，在事物中代表火器、光彩、电子、信息、广告、文学、语言、文章，在描述一个人特点中代表热情、激动、有文化，在环境场所中代表冶炼、战场、大厦、剧场、体育场、热闹的地方、学校，在人体中代表新章、小肠、血液、精力、血液、舌头，在人物中代表成熟年龄的女性、漂亮的人，桃花
	未:	在方位中代表西南偏南方，在场景环境中代表田园、酒店、工厂，在人体中代表、脾胃、肌肤、口腔，人物代表老年男性，在事件中代表宴席，在钱财中代表财帛，在疾病和长辈中代表孝服
	申:	在方位中代表西南偏西，在环境场所中代表道路、高大的楼、医院，在事物中代表疾病、官灾、掌权，在行业中代表金融机构、银行，在人体中代表肺、大肠，在动物中代表猴子，在职业中代表司法部门工作的人、军人、警察，在事物中代表有阻隔、法律、规定
	酉:	在方位中代表西方，人物中代表少女，在动物中代表鸟、鸡，在物品中代表器皿、金属物品、钟表、银行，描述事物中代表暗中隐藏隐瞒，暗昧不明，事物有缺陷，有口舌，在描述人的心情情绪中代表喜悦、欢乐，在场所环境中代表门、窗，在人体中代表肺、小肠、耳朵、骨骼、精气，桃花
	戌:	在方位中代表西北偏西，在地理环境场所中代表庙宇、加油站、电站、影院、市场、坟墓，在物品中代表炉子、古物，在刑罚官司中代表牢狱，在人体代表心包、后背、肌肉、鼻，在动物中代表狗、狼，在事物中代表是非毁败、虚伪、言约私契、文书、空话大话、开会
	亥:	在方位中代表西北偏北，在地理环境中代表池塘、沟渠、小河流，在人体代表头、肾脏、膀胱、尿道，在动物中代表猪、熊，在物品中代表酒、汤药，在人物中代表小孩，有小孩性格的人，在事物中代表科技、理性思维、网络、思想
	`
	prompt += "\n"
	...
	prompt += "用中文回答问题，并且要根据上面的背景信息，按分类输出分析结果，并且尽可能携带流年信息。\n"
	prompt += "现在我的问题是: "
