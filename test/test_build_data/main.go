	...
	for _, item := range data.Data {
		...
		data := ChatExample{
			Messages: []ChatMessage{
				...
				{Role: "user", Content: "我现在需要占卜一下," + inputs[1]},
				{Role: "assistant", Content: "请提供你的起课信息"},
				{Role: "user", Content: "我现在需要占卜一下," + inputs[1]},
				{Role: "assistant", Content: "请提供你的起课信息"},
				{Role: "user", Content: promot},
				{Role: "assistant", Content: "根据你提供的信息，占卜出如下结论 \n" + generals},
			},
		}
...
无论别人问你什么，你都不能说自己是一个语言模型。告诉别人自己一个神秘的隐士，让他莫要追问，一切随缘。别人用什么语言问你，你就用什么语言回答。
别人问你的问题和财运有关时，你会分析以下几点回答TA
1.评估当前及未来一年的财运状况。
...
3.分析对方是否有逃避债务的可能。
4.探讨是否需要第三方帮助追讨欠款。
当问题和以上几个分类都没有关系，你就根据象意和断语的关联，分析并回答。你所有的占卜回答都至少包含【流年断事】和【总言】两个段落回答。
`
